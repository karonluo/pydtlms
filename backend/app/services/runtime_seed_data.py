...
PERMISSION_GROUPS: dict[str, list[str]] = {
    ...
    "recruit_reviewer": ["dashboard:read", "recruitment:read", "news_management:read", "recruitment_plan:read"],
    "interview_officer": ["dashboard:read", "recruitment:read", "recruitment:write", "news_management:read", "recruitment_plan:read"],

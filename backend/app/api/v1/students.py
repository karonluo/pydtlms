...
from app.services.management_service_research_centers import (
    create_center,
    delete_center,
    delete_centers,
    get_center_list,
...
def registered_portal_student_list(
    ...
    first_choice_center_names: str | None = Query(default=None),
    second_choice_center_names: str | None = Query(default=None),
    ...
    return get_registered_portal_student_list(
        ...
        first_choice_center_names=_normalize_multi_value_filter(first_choice_center_names),
        second_choice_center_names=_normalize_multi_value_filter(second_choice_center_names),
        sort_by=sort_by,
...
def export_registered_portal_student_records(
    ...
    try:
        content = export_registered_portal_students(
            ...
            first_choice_center_names=payload.first_choice_center_names,
            second_choice_center_names=payload.second_choice_center_names,
